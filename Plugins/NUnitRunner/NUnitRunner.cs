...
namespace Mnk.TBox.Plugins.NUnitRunner
{
    ...
    public sealed class NUnitRunner : ConfigurablePlugin<Settings, Config>
    {
        ...
        private string NUnitAgentPath => Path.Combine(Context.DataProvider.ToolsPath, "NUnitAgent.exe");

        private string RunAsx86Path => Path.Combine(Context.DataProvider.ToolsPath, "RunAsx86.exe");
    }
}
