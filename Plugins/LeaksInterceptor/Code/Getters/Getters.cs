...
namespace Mnk.TBox.Plugins.LeaksInterceptor.Code.Getters
{
    ...
    class PrivilegedProcessorTime : DifferenceCalculator
    {
    ...
    abstract class DifferenceCalculator : IGetter
    {
