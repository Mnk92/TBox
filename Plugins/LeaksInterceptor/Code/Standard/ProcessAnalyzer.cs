...
namespace Mnk.TBox.Plugins.LeaksInterceptor.Code.Standard
{
    class ProcessAnalyzer : IAnalyzer
    {
        ...
        public ProcessAnalyzer(int targetPid, IEnumerable<string> counterNames, GettersFactory factory)
        {
